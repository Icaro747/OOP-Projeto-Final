            ...
            <div class="BoxLista">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a class="redirect" href="AtualizarFuncionarioServlet?ID=${funcionario.ID_funcionario}">Atualizar</a></td>
                        </c:if>
                        <c:if test="${acao.excl == true}">
                        <td><a onclick="Confirmacao(`${funcionario.nome}`,`${funcionario.ID_funcionario}`)" class="redirect btn_Excluir">Excluir</a></td>
                        </c:if>
                    </tr>
                    </c:forEach>
                </table>
